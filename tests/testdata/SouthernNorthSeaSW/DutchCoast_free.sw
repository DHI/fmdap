...
[FemEngineSW]
   ...
   EndSect  // SPECTRAL_WAVE_MODULE
      ...
      [TIME]
         start_time_step = 0
		 start_time_step_assimilation = 50 //(default=0) time to start assimilation
         time_step_factor_assimilation = 1 //refers to the overall time step
      EndSect  // TIME

	  [METHOD]
		type = 0               // 0=Free, 1=EnKF (ensemble), 2=Simple, 3=Steady, 4=EnOI 
		ensemble_size = 10
		//algorithm = 2          // (for type=1) 1=serialESRF, 2=DEnKF, 3=ETKF       
      ...
      [MEASUREMENTS]
         ...
         [MEASUREMENT_5]
            include = 0             // 0: inactive, 1: active used for DA, 2: active but only for validation
            name = 'Hm0_Cryosat2'
            measured_variable = 'SW%Hm0'
