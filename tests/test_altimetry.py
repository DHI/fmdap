...
def test_get_data():
    alti = altimetry.AltimetryDHI(user, pwd)
    df = alti.get_data(area='bbox=1,55,2,57', end_date = datetime(2018,2,1), satellites='sentinels') 
...
def test_save_to_dfs0():
    alti = altimetry.AltimetryDHI(user, pwd)
    df = alti.get_data(area='bbox=1,55,2,57', start_date='20190401', end_date='20190601')
    dfsfile = 'test.dfs0'
